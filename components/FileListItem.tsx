...
export function FileListItem({
  ...
  return (
    <div className={`p-3 sm:p-6 rounded-2xl border-2 transition-all duration-300 ${
      entry.enabled
            ...
            <>
              ...
              <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                <button
                  ...
                  aria-label="儲存"
                >
                  <Save size={18} className="sm:inline hidden mx-auto block sm:mr-1" />
                ...
                <button
                  ...
                  aria-label="取消"
                >
                  <X size={18} className="sm:inline hidden mx-auto block sm:mr-1" />
